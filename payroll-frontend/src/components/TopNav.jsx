          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-3 group cursor-pointer">
              ...
              <div className="relative">
                ...
                {/* User Menu Dropdown */}
                <div className="absolute right-0 mt-2 w-48 bg-gradient-to-b from-white to-gray-50 rounded-xl shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50">
                  <div className="p-3">
